...
class Products
{
  ...
  #[ORM\OneToMany(mappedBy: 'product', targetEntity: RelatedProducts::class)]
  private $relatedProducts;

  #[ORM\OneToMany(mappedBy: 'product', targetEntity: ReviewsProducts::class)]
  ...
  public function addRelatedProduct(RelatedProducts $relatedProduct): self
  {
  ...
  public function removeRelatedProduct(RelatedProducts $relatedProduct): self
  {
  ...
  /**
   * @return Collection<int, ReviewsProducts>
   */
